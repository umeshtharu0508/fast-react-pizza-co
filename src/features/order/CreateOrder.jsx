...
function CreateOrder() {
  ...
  return (
    <div className="px-4 py-6">
      ...
      {/*because react-router matches the closest route, so no need to pass the action*/}
      <Form method="POST">
        ...
        <div className="relative mb-5 flex gap-2 flex-col sm:flex-row sm:items-center">
          ...
          {!position.lattitude && !position.longitude && <span className="absolute right-[3px] z-50 top-[3px] md:right-[5px] md:top-[5px]">
